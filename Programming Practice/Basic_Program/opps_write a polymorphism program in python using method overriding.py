# Base Class Animal: The Animal class defines an abstract method speak() using raise NotImplementedError, signaling that subclasses must implement this method.
class Animal:
